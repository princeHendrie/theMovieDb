...
import {loadmore, firstTime} from '../actions/TopRatedTVShowsActions';
...
const mapStateToProps = ({ topRatedTVShows }) => {          
    const { listMovie, error, loading, loadingLoadmore } = topRatedTVShows;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (TopRatedTVShows);