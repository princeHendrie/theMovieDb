...
import {loadmore, firstTime} from '../actions/UpcomingMoviesActions';
...
const mapStateToProps = ({ upcomingMovie }) => {          
    const { listMovie, error, loading, loadingLoadmore } = upcomingMovie;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (UpcomingMovies);