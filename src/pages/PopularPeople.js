...
import {loadmore, firstTime} from '../actions/PopularPeopleActions';
        ...
        return (
           ...
           <FlatList
                       ...
                       <View style={{ flex: 1, flexDirection: 'column', margin: 1 }}>
                           ...
                           <ImageBackground style={styles.imageThumbnail} source={{ uri: hostImg+item.profilePath }}>
...
const mapStateToProps = ({ popularPeople }) => {          
    const { listMovie, error, loading, loadingLoadmore } = popularPeople;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (PopularPeople);