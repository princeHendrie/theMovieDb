...
import {loadmore, firstTime} from '../actions/NowPlayingMoviesActions';
...
const mapStateToProps = ({ nowPlayingMovies }) => {          
    const { listMovie, error, loading, loadingLoadmore } = nowPlayingMovies;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (NowPlayingMovies);