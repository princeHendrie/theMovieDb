...
import {loadmore, firstTime} from '../actions/PopularMoviesActions';
...
const mapStateToProps = ({ popularMovies }) => {          
    const { listMovie, error, loading, loadingLoadmore } = popularMovies;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (PopularMovies);