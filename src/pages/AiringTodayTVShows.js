...
import {loadmore, firstTime} from '../actions/AiringTodayTVShowsActions';
...
const mapStateToProps = ({ airingTodayTVShows }) => {          
    const { listMovie, error, loading, loadingLoadmore } = airingTodayTVShows;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (AiringTodayTVShows);