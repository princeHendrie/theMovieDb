...
import {loadmore, firstTime} from '../actions/PopularTVShowsActions';
...
const mapStateToProps = ({ popularTVShows }) => {          
    const { listMovie, error, loading, loadingLoadmore } = popularTVShows;

    return { listMovie, error, loading, loadingLoadmore };
};

export default connect(mapStateToProps, { loadmore, firstTime }) (PopularTVShows);